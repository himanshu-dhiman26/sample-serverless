...
var Blog = function Blog(props) {
  return __jsx(_components_basicLayout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: this
  }, props.blog.name), __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    __self: this
  }, props.blog.summary.replace(/<[/]?[pb]>/g, '')), __jsx("img", {
    src: props.blog.image.medium,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return fetch("https://api.tvmaze.com/blogs/".concat(id));
          ...
          case 6:
            blog = _context.sent;
            console.log("Fetched blog: ".concat(blog.name));
...
//# sourceMappingURL=[id].js.a1ebc9e2c637febb3535.hot-update.js.map