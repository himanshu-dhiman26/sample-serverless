      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("https://4vtblvzdme.execute-api.ap-south-1.amazonaws.com/dev/blogs/".concat(id), {
              headers: {
                "app_user_id": "test",
                "app_user_name": "test"
              }
...
//# sourceMappingURL=[id].js.4d2697d592003657fc98.hot-update.js.map